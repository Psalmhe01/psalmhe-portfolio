        ...
        <AppShell.Header px="md">
          <Group h="100%" justify="space-between">
            ...
            <Group gap="sm">
              ...
              <Button variant="subtle" size="xs" color="gray" onClick={logout}>
                Sign out
              </Button>
            </Group>
          </Group>
        ...
        <AppShell.Main>
          <Stack maw={860} mx="auto" gap="lg">
            ...
            {loading ? (
              ...
              <Stack gap="sm">
                {galleries.map((g) => (
                  <Paper key={g.id} withBorder p="md" radius="md" bg="white">
                    <Group
      ...
      >
        <Stack gap="sm">
          ...
          <Group justify="flex-end" mt="xs">
            ...
            <Button onClick={handleCreate} loading={creating} radius="md">
              Create Gallery
            </Button>
          </Group>
        </Stack>
