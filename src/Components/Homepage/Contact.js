            ...
            <div class="contact-container">
                ...
                <div className="forms">
                    ...
                    <div className="form-title">
                        ...
                        <input id="firstName" type="firstName" name="First Name" placeholder="Enter your first name"/>
                        <ValidationError prefix="firstName" field="firstName" errors={state.errors}/>
                    </div>
                    <div className="form-title">
                        <label htmlFor="lastName">Last Name *</label>
                        <input id="lastName" type="lastName" name="Last Name" placeholder="Enter your last name"/>
